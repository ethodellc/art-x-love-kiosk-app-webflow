...
(function (root, factory) {
  ...
  var KioskBoard = {
    ...
    Init: function (userInitOptions) {
      console.log('KioskBoard: init function called');
    ...
    Run: function (selectorOrElement, options) {
      ...
      var createKeyboardAndAppendTo = function (data, input) {
        console.log('KioskBoard:  creating keyboard');
        // all inputs
        var allInputs = [];
        ...
        var inputFocusListener = function () {
          ...
          var theInput = this;
          console.log('KioskBoard.   The input is: ', theInput);
          ...
          theInput.addEventListener('keypress', function (e) {
            console.log('keypress event detected on input field for virtual keyboard');
          ...
          var keysClickListeners = function (input) {
            console.log('KioskBoard: Setting up click listeners for input: ', input);
            ...
            if (eachKeyElm && eachKeyElm.length > 0) {
              for (var ekIndex = 0; ekIndex < eachKeyElm.length; ekIndex++) {
                ...
                console.log('KioskBoard: adding click event listener to this element: ', keyElm);
                keyElm.addEventListener('click', function (e) {
                  console.log('KioskBoard: Virtual keyboard key pressed.  Event info: ', e);
                  e.preventDefault();
                  ...
                  console.log('KioskBoard: key value: ', keyValue);
